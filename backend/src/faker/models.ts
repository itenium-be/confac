...
export function getNewClient() {
  ...
  return {
    ...
    telephone: `04${faker.string.numeric(2)} ${faker.string.numeric(3)} ${faker.string.numeric(3)}`,
    btw: `BE ${faker.string.numeric(3)}.${faker.string.numeric(3)}.${faker.string.numeric(3)}`,
