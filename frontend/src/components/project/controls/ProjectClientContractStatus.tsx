...
import {ContractBadge} from '../../client/controls/ContractBadge';
...
const ProjectClientContractStatusComponent = ({value, ...props}: BaseInputProps<string>) => {
  ...
  return (
    <div>
      ...
      <Button claim={Claim.ViewClients} variant="outline-dark" onClick={`/clients/${client.slug}`} style={{marginTop: -8}}>
