...
export const trans = {
  ...
  config: {
    ...
    invoiceReplacements: {
      ...
      date: 'Factuurdatum met FORMAT: jaar=YYYY, maand=MM, dag=DD',
      dateShort: 'Factuurdatum',
      orderNr: 'Bestelbon nummer',
      clientName: 'Naam klant',
      consultantName: 'Naam consultant',
      projectMonth: 'Project maand (FORMAT: YYYY, MM, MMMM)',
  ...
  invoice: {
    ...
    unverifyActionTooltip: 'Verificatie ongedaan maken',
    verifyActionTooltip: 'Factuur verifiëren<br>Openstaand voor {days} dagen',
    outstandingDays: 'Openstaand voor {days} dagen',
    clickToMarkPaid: 'Klik om de factuur als betaald te markeren',
    clickToMarkToPay: 'Klik om de factuur als te betalen te markeren',
    ...
    archiveTooltip: 'Archiveer — voor facturen die vastzitten in Concept/Te versturen en nooit verstuurd zullen worden',
    unarchiveTooltip: 'Dearchiveer — herstel naar de vorige status',
    archiveTitle: 'Factuur archiveren',
    archivePopup: 'Deze factuur archiveren? Ze blijft zichtbaar in de lijst en telt mee voor de nummering, maar wordt gemarkeerd als nooit verzonden. Billit wordt niet op de hoogte gebracht.',
    ...
    peppolNotSent: 'Nog niet verstuurd naar Peppol',
    ...
    peppolDelivered: 'Bezorgd',
    peppolSending: 'Wordt verstuurd',
  ...
  project: {
    ...
    client: {
      ...
      hoursInDay: 'Uren per dag bij de klant',
    },
    endCustomer: {
      clientId: 'Eindklant',
      contact: 'Contact',
  ...
  email: {
    ...
    lastPeppolDaysAgo: '{daysAgo} naar Peppol gestuurd.',
