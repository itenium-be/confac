...
export const trans = {
  ...
  invoice: {
    ...
    missingAccountingCode: 'Geen kostendrager ingesteld voor consultant:',
  ...
  projectMonth: {
    ...
    consultant: 'Consultant',
    missingAccountingCode: 'Geen kostendrager ingesteld voor deze consultant',
    title: 'Projecten maand',
    listTitle: '{month} {year}',
    filterUnverified: 'Enkel niet gevalideerde',
    filterOpenTimesheets: 'Enkel open timesheets',
  ...
  email: {
    ...
    prepareQuotationEmail: 'Offerte emailen',
    to: 'Naar',
    toPlaceholder: 'Email adressen met ; scheiden',
    cc: 'CC',
    bcc: 'BCC',
