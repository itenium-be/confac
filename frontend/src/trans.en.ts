...
export const trans = {
  ...
  config: {
    ...
    invoiceReplacements: {
      ...
      date: 'Invoice date with FORMAT: year=YYYY, month=MM, day=DD',
      dateShort: 'Invoice date',
      orderNr: 'Invoice ref',
      clientName: 'Client name',
      consultantName: 'Name consultant',
      projectMonth: 'Project month (FORMAT: YYYY, MM, MMMM)',
  ...
  quotation: {
    title: 'Quotations',
    pdfName: 'Quotation',
    createNew: 'New quotation',
    date: 'Date',
    orderNrShort: 'Order nr',
    editTitle: 'Quotation details',
    createTitle: 'New quotation',
    number: 'Quotation number',
    fileName: 'Pdf filename quotation',
    addLine: 'Add quotation line',
    create: 'Create quotation',
    period: 'Period',
    amount: 'quotations',
    amountOne: '1 quotation',
    deleteTitle: 'Delete quotation',
    deletePopup: 'Delete quotation {number} ({client}) permanently?',
    deleteConfirm: 'Quotation deleted',
    createConfirm: 'Quotation created',
    consultant: 'Consultant',
  ...
  invoice: {
    ...
    verifyAction: 'Verify invoice',
    unverifyActionTooltip: 'Undo invoice verification',
    verifyActionTooltip: 'Verify invoice<br>Unpaid for {days} days',
    outstandingDays: 'Outstanding for {days} days',
    clickToMarkPaid: 'Click to mark the invoice as paid',
    clickToMarkToPay: 'Click to mark the invoice as to pay',
    ...
    archive: 'Archive',
    unarchive: 'Unarchive',
    archiveTooltip: 'Archive — for invoices stuck in Draft/ToSend that will never be sent',
    unarchiveTooltip: 'Unarchive — restore to its previous status',
    archiveTitle: 'Archive invoice',
    archivePopup: 'Archive this invoice? It will remain in the list and counted for numbering, but marked as never-sent. Billit will not be notified.',
    ...
    peppolNotSent: 'Not yet sent to Peppol',
    ...
    peppolSaveFirstTitle: 'Unsaved changes',
    peppolSaveFirstMessage: 'Please save your changes before sending to Peppol.',
    ...
    peppolDelivery: 'Delivery',
    peppolDeliveryStatus: 'Status',
    peppolDeliveryDate: 'Date',
    peppolDeliveryDelivered: 'Delivered',
    peppolDeliveryInfo: 'Info',
    peppolDelivered: 'Delivered',
    peppolSending: 'Sending',
    peppolMessages: 'Messages',
    peppolMessageSuccess: 'Successful',
    peppolMessagePending: 'Pending',
