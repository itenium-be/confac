...
function fetchClients() {
  return dispatch => {
    return httpGet('/clients').then(data => {
      dispatch({
...
function fetchConsultants() {
  return dispatch => {
    return httpGet('/consultants').then(data => {
      dispatch({
...
function fetchProjects() {
  return dispatch => {
    return httpGet('/projects').then(data => {
      dispatch({
...
function fetchConfig() {
  return dispatch => {
    return httpGet('/config').then(data => {
      dispatch({
...
function fetchInvoices() {
  return dispatch => {
    return httpGet('/invoices').then(data => {
      dispatch({
...
function fetchProjectsMonth() {
  return dispatch => {
    return httpGet('/projects/month').then(data => {
      dispatch({
